...
The early versions of the system was hopeful but slow. It took 10 minutes to decode 10 words, and the head of their department told them IBM viewed MT as a luxury. Fortunately, DARPA came to the rescue. Like how it [used to fund those speech recognition projects](#sec-TODO), DARPA was funding MT projects.
...
The pendulum is stuck in the abyss of Empiricism.
...
* Finally they got the laser patent corpus, whose vocabulary was finally small enough!
...
* "Some oil company... were concerned about turning over complete documents; fortunately, we were able to convince them to allow us to collect a sorted list of all 11-gram snippets that appeared in their text." Then they reconstructed the text as if sequencing [DNA contigs](https://en.wikipedia.org/wiki/Contig)!
...
[^hong-kong-hansard]: The Canadian Hansard took only a small amount of cleaning. A Hong Kong researcher, Dekai Wu, was inspired by the research. It took him 5 months in 1992 to construct an English--Chinese corpus from the Hong Kong Hansard (Both Hong Kong and Canada used to be British colonies, so both have Hansards). It began with "We sort of try to convert it into Mandarin but there’s a lot of things that are said, they use Cantonese words that don’t actually have official characters... We’re making up codes here in this office." and ends with "We store them in all these little 8 mm magtapes in an Apple proprietary cartridge form that Apple canceled five years ago... We have one reader." [@brownOhYesEverythings2013]
