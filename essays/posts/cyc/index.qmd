...
At a slower tier is example-based machine translation by syntax templates. For example, in "... the heart of Baghdad ...", the first pass parses Badhdad as a city, then a syntax template activates and it parses the "heart" as `CentralRegion`. This probably needs a few billion example templates, which means it must be acquired mostly automatically.
