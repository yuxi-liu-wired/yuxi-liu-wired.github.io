...
* Glaxo Wellcome, [DEC](https://en.wikipedia.org/wiki/Digital_Equipment_Corporation), IBM, and [United Healthcare](https://en.wikipedia.org/wiki/UnitedHealth_Group), sometime before 1997, for unknown purposes. [@portDuelingBrainscapesArtificial1997] For Glaxo Wellcome, and United Healthcare, it was probably for the purpose described below. For DEC and IBM, probably to produce specialized expert systems -- after all, DEC was famous for using the expert system [XCON](https://en.wikipedia.org/wiki/Xcon) that saved them $40M/year. [@rolandStrategicComputingDARPA2002, page 191]
