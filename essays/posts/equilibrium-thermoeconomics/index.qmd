...
To perform work, one must perform work *upon* something. In other words, there is no such thing as "system A performed work". There is really "some energy and length is traded between A to B in compliance with an equation constraint, such that the total entropy of the compound system has remained constant".
...
Quiet. We did not open the middle wall. We did not wait. Gas did not expand. The past did not cause the future. Time is an stubbornly persistent illusion, and causality too.
