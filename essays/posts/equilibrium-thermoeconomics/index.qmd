...
In general, if we pick $x_1, \dots, x_d, y$ from a list of many scalar functions on a surface, such that $x_1, \dots, x_d$ form a coordinate system on the surface, then we can express $y = f(x_1, \dots, x_d)$ for some function $f : \R^d \to \R$, and define
