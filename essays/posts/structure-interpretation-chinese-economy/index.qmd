...
1. The state knows better, because the state aspires to plan over decades, unlike people or companies.
2. China deserves to be a center of civilization. Not necessarily better than everyone else, but must be one of the best.
3. Never forget national humiliation. (勿忘国耻) The international world is a world of anarchy, and might makes right. Backwards countries are beaten. (落后就要挨打)
4. Power comes from technological development. Development is the only hard truth. (发展才是硬道理) 
5. To be one of the best, China must catch up to the Western countries.
6. To catch up, it must develop its economy. Economy depends on scalable industry of material products (实体经济), such as steel and silicon.
7. People do not know how they should spend their money. Their money must be extracted to be rolled into investment for the future. The far future is what matters, not the present, and not even the near future. If people are left with too much money, they will waste it.
...
Previously, urban people took work in the work units, and the work units provided their housing. With the end of many SOEs, mass public housing had to end as well. Thus in the 1990s came housing market reform, with the most comprehensive one in 1998. From then on, most urban people could not expect to get public housing, and had to buy their own. This has a long effect on the Chinese housing market.

Around 1990, the reform and opening-up had gone on for over 10 years, and the center was feeling uneasy, especially in light of what had just happened in the capital. For the first time since the communists took power, the power of the center was shrinking. Hardliners urge a return to the red days of glory, but the paramount leader Deng Xiaoping forced through more reforms. The main difficulty at this point was a fiscal one: The quantity (income of the central government)/(GDP) was decreasing, and if this kept going on, the central government would no longer afford even the military, and they feared China would suffer [the fate of Yugoslavia](https://en.wikipedia.org/wiki/Breakup_of_Yugoslavia).
...
$\frac 12 \min(x_t, 1.04 x_{t-1})$ to the central government. That of Guangdong, 1.09 of whatever it paid last year. That of Shanghai, 10.5 billion yuan regardless.

No matter the complexity, the general pattern is that the local governments could keep most of the growth, thus as the GDP grew, the center shrunk. This was intolerable, thus in 1994 came a comprehensive tax reform. This ensured that all consumption tax and 75% of value-added tax would be handed up to the central government. [@chungBeijingConfrontingProvinces1994] However, as the diagram shows, the deal was quite difficult for the local governments, who had to make-do with much lower tax revenue, but still shoulder most of the expenditures.

![The portion of the local governments, as a portion of the total government revenue and expenditure. [Source](https://www.rba.gov.au/publications/bulletin/2024/oct/the-abcs-of-lgfvs-chinas-local-government-financing-vehicles.html)](figure/LocalGovernmentRevenueandExpenditure.svg)

### The modern era (2000--)

In 2001, China joined the [World Trade Organization](https://en.wikipedia.org/wiki/World_Trade_Organization), and became the manufactory of the world. Economic reform has stabilized, and the Chinese economy settled into a stable and working form. This is depicted into the following diagram.

![The Chinese economy during the modern era.](figure/Chinese_economy_fig_3.png)

The central government owned a majority of government revenue, and could apply it for its industrial policy, either directly through policies and subsidies, or indirectly through the state-controlled banks. The banks would provide highly preferential loans to good industries, and vice versa. In this way, the economy could be planned and controlled softly.

After the 1994 tax reform, many local governments had to spend more than they earn in taxes, year after year. This could not continue, and indeed, it would not, because they had one thing that they had a monopoly of -- the right of land use. Since the communists took power, all land had always belonged to the state or the collective. Reforms merely privatized the right of land use.

In detail, the Land Management Law was reformed in 1998. According to the reformed version, if land designated as agricultural is to be converted into land designated as non-agricultural, it must be first acquired by the state. The effect was that the local governments became monopolists of land. City governments would buy up land from farmers on the periphery at low prices, then sell them at high prices to the real estate developers, who would then build housing and sell them to private citizens and enterprises at even higher prices. The local government would spend the revenues on funding infrastructural developments for two goals:
...
* The loans are implicitly backed by the reputation of the government, because even though these LGFV are not *legally speaking* part of the local government, it is implicit public knowledge among people doing business in China.
...
Generally, to grow an economy, there are only 2 methods: increase the raw material of capital stock (land, labor, natural resources) and increase technology with which to use the raw material. In symbols, those two methods are of increasing $K, L$, and increasing $A$. 
...
Eventually $L$ would hit a peak after the [demographic transition](https://ourworldindata.org/demographic-transition), and from that point on, most of economic growth must rely on the growth in $A$, the TFP.

In the 19th century, the classical economists -- Ricardo, Adam Smith, and John Stuart Mill[^mill-stationary-state] -- all believed that there is a limit to growth. Mill in particular believed that 19th century England was already close to that limit. This they believed, because land is where all raw material comes from, and land is not getting any bigger. This is still true. Neither land nor population has been growing significantly in the developed countries, but their economy still manage to grow continuously past these pessimistic expectations because of continuous technological progress that increases TFP.
...
Consider the following chart of the TFP of several representative countries: the United States, Taiwan, Japan, the United Kingdom, and China. They can be roughly described as follows:
...
And that, in broad strokes, is the catchup days of Soviet Union, China, Taiwan, South Korea... You might notice that it sounds quite authoritarian. Perhaps it's human nature, but rapid catchup just is often done by an authoritarian government. The cases of Soviet Union, China, and Taiwan are well-known. South Korea was a brutal dictatorship with several bloody coups, until around 1980s when it abruptly transitioned. North Korea, despite its terrible state of economy now, had been in fact progressing faster than South Korea until the 1980s. And [the Japanese economy had been quite planned](#sec-japan), too.
...
In terms of technological upgrades, factories are built in the 1960s and did not progress much further. They preferred to repair old machines than throwing them out and building new ones that are more efficient. This contrasts with Japan, which, after getting bombed to oblivion in WWII, built most of its industry at the cutting edge.
...
```{=html}
<div align="center"><iframe src="https://data.worldbank.org/share/widget?end=2023&indicators=NE.EXP.GNFS.KD&locations=JP&start=1970" width='450' height='300' frameBorder='0' scrolling="no" ></iframe></div><!-- exports_goods_services_Japan.png -->
```
...
* Japan is consistently exporting much more than importing. This means more Americans want JPY than Japanese want USD. This increases the value of JPY compared to USD, and pushes up USD/JPY to decrease export and increase import. This is just economic negative feedback in action.
...
As land prices increased, it increased the value of land as collateral, enabling companies to borrow more money, and banks to lend more money while satisfying the reserve requirements. Companies could use the borrowed money to buy more land, betting that it would rise more.
...
```{=html}
<div align="center"><iframe src="https://data.worldbank.org/share/widget?end=2023&indicators=NY.GDP.PCAP.KD&locations=JP&start=1970" width='450' height='300' frameBorder='0' scrolling="no" ></iframe></div><!-- GDPpc.png -->
```
...
For the private companies, they must not escape the control of the state. All companies are legally required to establish branches of the CCP. As soon as one company grows large, these branches would allow government to assert power over the company. Not direct control, as the party knows that direct control of the economy will lead to economic collapse, but some control they will assert. If it still does not submit, then it will be forced. [Jack Ma](https://en.wikipedia.org/wiki/Jack_Ma), the CEO of Alibaba (China's Amazon) was forced into retirement, because he was too rich and did not submit to *suggestions* that he donate more money, or sell off some of his voting stocks for the company. If he would not let go of his company and retire rich on his own terms, he would be forced to.
...
Indeed, if there's something growing faster than the Chinese economy, it is the Chinese housing market. In 1998, the Chinese government has privatized the housing market, and since then, the price of housing has grown very consistently. This is despite many warnings of imminent bubble collapse, and despite agreement by all economists and supreme leaders that housing is fundamentally not a growth industry -- after all, housing is just another machine that produces something economically useful, but not more than that. A car produces travel. A house produces living space. A camera produces photos. And productive machines break down over time, so that their price ought to decrease over the years. And yet, the opposite has been true. The price of an apartment, even one that is being lived in, mostly goes up, faster than GDP.

![Growth of the Chinese housing market, GDP, and disposable income. [Source](https://www.nber.org/digest/jul15/demystifying-chinese-housing-boom), which is an overview of [@fangDemystifyingChineseHousing2016].](figure/chinese%20housing%20and%20income.jpg)

Indeed, it is a grim comedy that over the years, often the government would say it wants to make apartments cheaper, and yet keeps allowing it to rise, and whenever there had been an actual fall, immediately implements policies to make it rise again. What explains it? The short answer is that housing is used to play several roles, which pulls it in opposite directions.

From the simple industrial point of view, a house is just a machine for living. As a place for living, its price should go down as companies learn to build things faster and cheaper. Indeed, the Chinese construction companies have been producing so much concrete, steel, and housing, that they have utterly overproduced for the Chinese market. The supply has so far outstripped demand that Chinese construction seeks market abroad, [mainly in Africa](https://www.economist.com/middle-east-and-africa/how-chinese-firms-have-dominated-african-infrastructure/21807721) and [South America](https://www.bu.edu/gdp/2024/07/30/china-latin-america-and-the-caribbean-deepen-ties-as-chinese-firms-shift-to-direct-investment-and-infrastructure/), where there is much greater demand for everything infrastructural -- housing, electricity, subway, etc. So, by the basic laws of economics, the price of housing ought to fall, like the price of water, books, housing, batteries, transport, and every machine good and proper in this world.
...
From the citizens' point of view, since the Chinese citizens have no other good investment tool than the housing market, its price should keep going up as China becomes richer, else people would be very upset and cause "social instability". Indeed, brief falls in housing market reliably creates social unrest, which is quickly followed by government making new policies that shows its commitment to unwavering rise in housing prices. And thus is social stability restored for another year. And this is despite the paramount leader of China repeatedly saying that ["Houses are for living, not for speculation."](https://en.wikipedia.org/wiki/Houses_are_for_living,_not_for_speculation), because when it comes down to it, social stability always triumphs over ideology.[^butt-brain]

[^butt-brain]: Why have not people caught on to the contradiction? I have no idea. Perhaps, as the Chinese says, "Your butt determines your brain." (屁股决定脑袋), meaning that your situation determines your thinking. It is hard to get a human to understand logic when their property value depends on them not understanding it. So even if people agree that, yeah, logically speaking, if the president says that "Houses are for living, not for speculation.", then the government should not be propping up the housing prices. But logic should not be an obstacle for another decade of prosperity. After all, logic is sublated by dialectics, and "All that is actual is rational." (存在的就是合理的), and "The words are hard and dead-fixed, but people are supple and living." (规矩是死的，人是活的), and I can keep quoting all those fine flowers of classic Chinese wisdoms that justify everything and explain nothing.
...
From the local governments' point of view, housing is how they are funded. The 1994 tax reform means most tax revenue is taken by the central government. They were not allowed to issue bonds until a 2015 reform. And yet they hold a monopoly on land use rights. Inevitably they want housing prices to keep going up.

From the real estate developers' point of view, they have long come to expect housing prices to keep rising, and plan their finances accordingly. Specifically, they borrow a lot from banks in order to fund their next construction project, which they expect to sell out quickly at high prices, which can then fund the next one, and so on. If the rising prices falters, it can threaten to break the cash flow, even bankruptcy.

From the bureaucrats' point of view, rising housing prices is a career necessity. The center rewards those who increase the GDP and keep stability. If housing prices drop, it would hurt citizens' investments and create instability, even protests. Conversely, to increase the GDP, the most assured path is to continue what has been working so far: build infrastructure and sell housing. Rising housing prices would then come naturally, since better infrastructure increases the value of land. There is also a perverse incentive involved, as they know that the central government would not allow local governments to go bankrupt, so they are free to raise more debt (either directly or indirectly via LGFV) to fund more development. At the limit, this results in [empty airports](https://www.reuters.com/article/us-china-infrastructure-insight/lovely-airport-where-are-the-planes-chinas-white-elephants-emerge-idUSKBN0N02AT20150410/) or [railway stations](https://news.qq.com/rain/a/20240525A00AKA00).

For all these forces pushing for a rise in housing prices, somehow everybody expects this to end someday, but few want this to end soon. The dangers are many:

* Expensive housing makes young people marry later. Chinese culture basically requires the man to buy an apartment before even marrying. Thus, expensive housing → later marriage → less children → weaker economy.
...
If American stock market contains *just* stocks in one sector, like oil, then America would have the same problem. However, American stock market contains every sector from oil to computer to the military, so we have a system that adapts to the rise of each new technological breakthrough. When a new breakthrough, such as electric cars, first arises, the rate of profit for the relevant industry would rise abruptly. But as it becomes old news, the profit rate will fall, down to merely keeping up with inflation, because they have discovered all the good ways to make the thing and there are no more improvements. People are no longer interested in buying more stocks in the companies here. People who are okay with more risk and more reward will just sell these stocks and buy stocks in new companies in new growing sectors, like AI.

In this way, a diverse market allows efficient capital allocation across the economy.

Now in China, the housing market is too dominant, and this distorts capital allocation, into pouring more capital into the build of infrastructure, steel plants, machine plants, houses, etc, than what would be efficient. At the limit, this results in the absurd [ghost cities](https://en.wikipedia.org/wiki/Underoccupied_developments_in_China). Making misallocation worse is the aforementioned moral hazard, where bureaucrats benefit from the GDP growth in investing in more infrastructure and housing, and insulated from the cost when it turns out to be wasted.
...
* Culturally, make it more acceptable for people to not own housing, and make permanent renting a viable choice.
* Accept on the macro policy level that people are going to keep pouring into the big cities and leave many small cities, and instead of trying to tell people to return to the quiet life of a small city and develop their hometowns, embrace it. Zone land for residential development in proportion to projected urban population. In particular, zone more land for the growing cities, and zone less for the shrinking cities. This depends on accurate projections, but predicting future population movement is generally easier than predicting the political winds.
* Legalize and support Real Estate Investment Trusts. These trusts would play similar roles as the LGFV, but legible and regulated. It would separate the local government from real estate development. The benefit would be that the government's legitimacy would be unharmed if a trust goes bankrupt. The cost would be, once again, less control by the state and a dangerous rise of market autonomy .
...
* Liberalize or even remove the Hukou system. The Hukou system was a no-tech method for making a billion people legible. The new information surveillance systems has obsoleted it. Removing it would allow people to flow more freely, decreasing misallocation.
...
Generally, it is a hard task with multiple contradicting constraints, but China seems confident in taking it on by experimenting multiple methods at multiple cities. It is big enough to do so, and contradictions that can be managed indefinitely are just fine.
...
I originally intended this to be a quick blog post, so it is distinctly under-researched, and large chucks of it is pulled out of my brain that I am not bothered enough to find citations for. As I kept trying to polish it, it grew too long to be a blog post, so it is now a proper essay, but it is still uneven, kind of repetitive, and lacks citations to really satisfy my wish for completeness. Still, an essay it is.
