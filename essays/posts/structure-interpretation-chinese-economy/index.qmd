...
Previously, during the decades of war, the nationalist government did what war-time governments often did -- print money. This led to repeated hyperinflation episodes and the collapse of 3 fiat currencies. The communist state solved the issue by backing fiat currency with a basket of basic commodities such as grain and steel, and by controlling prices, wages, production quotas, the banks, etc.
