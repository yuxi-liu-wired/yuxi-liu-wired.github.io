...
```{=html}
<div id="svg-container-white"></div>

<div id="svg-container-black"></div>
```
...
The point being, algorithmic fairness left the realm of philosophical and political debates and entered the realm of bureaucracy. Fairness is no longer the key to the meaning of life and self-worth, but a matter of passing statistical tests.
