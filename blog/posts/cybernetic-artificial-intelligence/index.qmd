...
::: {.proof}
The direct definition of $L_n$ satisfy $xL_n'' + (1-x) L_n' + nL_n = 0$, and has the same value and first derivative at $x=0$. By the uniqueness theorem of ordinary differential equations, the two definitions are equal.
...
Directly compute the left side, and find that it equals $\sqrt\pi e^{2st}$. Now expand it in powers of $s, t$.
:::
