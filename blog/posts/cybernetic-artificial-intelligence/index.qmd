...
The Laguerre functions makes the orthogonality cleaner:

$$
\int_0^\infty \psi_n(t)\psi_m(t) dt = \delta_{mn}
$${#eq-laguerre-function-orthogonal}

Just like in Fourier analysis, by virtue of orthogonality, we can represent any well-behaved function on the $(-\infty, t]$ as an infinite sum of Laguerre functions
