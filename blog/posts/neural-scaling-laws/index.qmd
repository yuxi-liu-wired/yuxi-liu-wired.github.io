...
The paper \"Training Compute-Optimal Large Language Models\" [@hoffmannTrainingComputeOptimalLarge2022a] reported a series of training runs on language models, trained by Google DeepMind researchers. Each training run is characterized by four numbers:
