...
Assuming that, we expect an AGI GPT to have $10^{15}$ parameters, or 1000×.
...
According to "Carbon emissions and large neural network training"[@pattersonCarbonEmissionsLarge2021], the carbon emission of training GPT-3 is 552 tCO2. According to a [2021 poll of climate economists](https://www.reuters.com/business/cop/carbon-needs-cost-least-100tonne-now-reach-net-zero-by-2050-2021-10-25/), 1 tCO2 emission should cost somewhere between 50 and 250 USD. Let's take their geometric average of 112 USD.
