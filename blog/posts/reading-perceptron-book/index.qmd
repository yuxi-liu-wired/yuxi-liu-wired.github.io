...
For those interpretations, see [*The Perceptron Controversy*](https://yuxi-liu-wired.github.io/blog/posts/perceptron-controversy/).
...
In other words, we only need to look at the binary values $x_{i_1}, ..., x_{i_k}$ to determine the binary output $\psi(x)$.
