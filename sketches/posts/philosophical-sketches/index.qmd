...
Pierre Menard, the obscure 19th-century Swiss-French biologist (1832-1891), remains virtually unknown despite his remarkable undertaking. Despite a contemporary, Menard was neither strictly Darwinian nor Lamarckian, though elements of both theories harmonized within his work alongside orthogenesis and recapitulation.

Menard's oeuvre began with an observation in his 1867 treatise "Des Erreurs Transmises" \[On Transmitted Errors\]: 
...
> 10/04/87, 17-β. App. mpts. Dbl. transitifs. d.env. univ.? Conforme à l'extrapolation de l'os crochu.

The entry might be translated as: "On 1887-04-10, I slept in the 17-β orientation. [Metaplectic](https://en.wikipedia.org/wiki/Metaplectic_structure) appendages. [Doubly transitive](https://en.wikipedia.org/wiki/Multiply_transitive_group_action). The universal denvelope? It fits the extrapolation of the [hamate](https://en.wikipedia.org/wiki/Hamate_bone)."

In Menard's theory, a blend of evolution and orthogenesis, all creatures, including the human, evolves, but not accidentally of the Darwinian kind. Instead, the necessary constraints of environment, as if by a million little nudges, guides evolution towards an ideal form. Unlike Darwin's branching tree of contingent adaptation, Menard envisioned orthogenesis as a process of correction, each generation a slight adjustment along the "[Quetelet](https://en.wikipedia.org/wiki/Adolphe_Quetelet) lines", after that indefatigable measurer of mankind, whose tables he referenced extensively. For example, he noted the variance in the curvature of the hamate bone decreases at an approximately logarithmically linear rate, suggestive that after an infinity of generations, variance would completely vanish, resulting in the "convergent state". Certain bones he predicted would disappear completely, while other "atavistic forms" would in fact flourish into complete forms, which he called "vestigial forms of the future".
...
As his work progressed, Menard became increasingly reclusive, going down from Mont Salève monthly only for essential supplies and tithes to regional hospitals. Sometime no later than 1885, he began experimenting with fertilized chicken eggs to induce "controlled unrolling toward the archetype" through chemical injections, isothermal chambers, and other interventions in a systematic attempt to discover and eliminate all forms of noise in the [internal and external milieu](https://en.wikipedia.org/wiki/Internal_environment). His notebooks from this period contain detailed drawings of embryos exhibiting novel structural elements arranged in tables shaped in squares and spirals. The local priest, concerned by rumors of these experiments, visited Menard's laboratory but left without comment, requesting shortly thereafter a transfer to another parish.
