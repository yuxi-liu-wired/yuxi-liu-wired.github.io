...
This essay is written as a companion piece of a lecture on the history of neural networks. It is not exactly an essay, but more of an extended scrapbook of quotations. The lecture slides will be posted in my GitHub repo.
...
![Looks like a Hopfield network? [@rosenblattPrinciplesNeurodynamicsPerceptrons1962, figure 47]](figure/Rosenblatt_1962_Hopfield.png)
...
>
> [@nilssonQuestArtificialIntelligence2009]
...
Noam Chomsky is totally against statistical language modelling. See also [@norvigChomskyTwoCultures2017].
...
Yehoshua Bar-Hillel, speaking in the 1960s, against machine translation: Statistical language modelling does not work better than manually programming in the rules. Winograd schema challenge requires general world understanding, which is "utterly chimerical and hardly deserves any further discussion'.
