...
author: "Yuxi Liu"
date: "2025-06-14"
categories: [slice-of-life, AI, biology, economics]
format:
  html:
    code-fold: true
    toc: true
...
During 2025-06-10--2025-06-12, the [Reproductive Frontiers Summit (ReproFro) convention](https://berkeleygenomics.org/events/ReproFro2025.html) was hosted in the San Francisco Bay Area. Gwern invited me to the afterparty in Lighthaven, so I went. I wore my serious-business-dress and carried around *Behavioral Neurobiology: An integrative approach* [@zupancBehavioralNeurobiologyIntegrative2018]. Not to read it, but as a comfort object.

## US Constitution

"... so Bismarck Analysis produces geopolitical analysis subscribed to by billionaires. They have made some seriously wrong analysis, like the one about [the Russian military being modernized enough to win wars](https://brief.bismarckanalysis.com/p/modern-russia-can-fight-and-win-land), but generally pretty good quality."
...
"Well, geopolitical analysis is also useful to the 'political scientists' as an identity utility. Some have billions of dollars to protect, and some their ego."
...
"Like if you look at the original constitution, the president had very limited powers. It and the federal government was almost ceremonial in a way. Most of the powers were in the states. It was designed for a small agrarian society."

"--In Germany the president is still like that."

"I thought Germany has only a prime minister."

"Oh, there really is a president. Not elected, but appointed. He doesn't do much really."
...
"So the parliamentary system is more reactive than the current government system of America."
...
"It is also why the [Nobel laureate sperm bank](https://en.wikipedia.org/wiki/Repository_for_Germinal_Choice) didn't do that well. Other than the lack of donors, there is also the lack of demand. Parents just seem less interested in intelligence than heredity, and would gladly have a kid that is dumber than like 15 IQ points if it is 'theirs'. And also why infertile parents don't usually adopt."

"Of course, there is also the fact that adopted children have way more psychological problems."

"People often say things like 'he has your eyes' and things like that. If you ask them pointedly they might say it is not that much of a big deal, but if you look at what people do instead of what they say, we can find their [implied preferences](https://en.wikipedia.org/wiki/Revealed_preference), and it shows people really care about their children having copied a lot of their own genomic content"
...
"Kyoto is too designed for tourism. Nagasaki shows the most standard kind of Japan. It's like a typical Japanese city, so it allows you to get a better view of Japan as it is seen by Japanese than Kyoto."
...
"Yeah, like I have never been to Japan. I know, it's the most ungwernlike thing. Somehow the LLMs assume that I have went to Japan. One of them even hallucinated an entire Gwern essay about 'My visit to the [Ghibli Museum](https://en.wikipedia.org/wiki/Ghibli_Museum)'. Actually that is an interesting thing. It was designed by the [son of Miyazaki](https://en.wikipedia.org/wiki/Goro_Miyazaki), and the park is great. He is a good architect, but a horrible movie director. The conspiracy theory is that Hayao Miyazaki keeps allowing him to direct movies to make up for being an absent father."
...
"More and more of animes coming out of Japan with a backdrop of declining civilization and population. But the authors don't even put it on the upfront, or point at it as if it is a special thing. It was kind of just a standard unremarkable thing to assume! It is probably hard to understand to a country with a rising economy though, and we would think it's an artistic choice, but it's probably because it's realistic for them. There are whole towns in Japan with all the infrastructure, but without people to use or maintain them."
...
"In Lighthaven there is a podcast room. It just has 5 cameras running 24/7. The storage space is about 1 TB per day. People could just go in and start talking spontaneously, and when they get back they can email Lighthaven for a video, and they would just cut out the relevant segments and send to them. And there's your podcast!"
	
https://x.com/hsu_steve/status/1933420846087110725

"Very smart. Every conference venue should have such a room."
...
"Yes. And audio is more important than video for podcasts, so they could use high compression for videos. Still, my intuitions were formed in the past, so it still sounds crazy to me on an emotional level. Also, they use a wired cable connection to the storage unit, which is 8 times faster than wifi. And they only keep the video stored for maybe a month so it doesn't cost that much."

In a conference room, we saw a map of power lines.
	
"I wonder what that straight line on South America is..."
		
o3 could not identify it. I looked hard at it and found nothing. I superimposed the map on a real world map in [Mollweide projection](https://en.wikipedia.org/wiki/Mollweide_projection). Here's what I could figure out.
		
There is absolutely nothing at (15°N, 56°W).
...
A few minutes later, they have collapsed to the ground and writhed like mating snakes.
...
[SAYCam dataset](https://pmc.ncbi.nlm.nih.gov/articles/PMC8412186/), [Learning high-level visual representations from a child's perspective without strong inductive biases](https://www.nature.com/articles/s42256-024-00802-0), [Grounded language acquisition through the eyes and ears of a single child](https://www.science.org/doi/10.1126/science.adi1374), [Moculus: an immersive virtual reality system for mice incorporating stereo vision](https://www.nature.com/articles/s41592-024-02554-6), [Parallel development of object recognition in newborn chicks and deep neural networks](https://journals.plos.org/ploscompbiol/article?id=10.1371/journal.pcbi.1012600), [Predicting the birth of a spoken word](https://www.pnas.org/doi/abs/10.1073/pnas.1419773112)

## Neuroplasticity

"Have you ever went to the [Exploratorium](https://en.wikipedia.org/wiki/Exploratorium)? It was actually opened by [Oppenheimer's brother](https://en.wikipedia.org/wiki/Frank_Oppenheimer), and it had the first interactive expositions. And that model is copied across the world in other science museums. It's certainly a better legacy than the atomic bomb."
...
"Some animal psychologists have done the same with birds. They would strap the deflection goggles to the birds. The barn owls could *kind of* adapt? But the chickens could never adapt. They would always be pecking [pecking motion with a [chevuoi](https://en.wikipedia.org/wiki/Che_vuoi%3F) hand] to the side, and would literally starve to death without help." [@knudsenVisuomotorAdaptationDisplacing1989]
...
"Bird brains are superior in every way. They can do the same thing but at a small size. I mean, the scaling curves have roughly the same exponent, but the constant is different. It seems they are just better by a constant factor. Ravens have societies. They use tools. They have teaching. They can transmit culture across generations and societies. The more we test them, the more they [seem to be at the level of primate intelligence](https://www.nature.com/articles/s41598-020-77060-8), and the more frighteningly close that they seem to be on the cusp of civilization. And it seems like a very contingent thing now, that it was primates, not birds, that created the first technological civilization. 
	  ...
	  Birds have one big disadvantage, and it is that flying is a horrible way to move. It costs so much energy, which forces them to be lightweight, and shrink their brains. if the earth atmosphere had been thicker...  
	    
	  Evolutionarily, humans arose out of primates scavenging on the African savannah, sucking up [bone marrows of the fresh kills](https://www.journals.uchicago.edu/doi/10.1086/701477). And it was a lucky break that the environment had been just rich enough for rewarding bigger brains. And walking is better than flying for this. Walking with a bigger brain is no big deal, but flying with a bigger brain... [gestures a bird plummeting head-down]" Indeed, [birds that expend more energy flying tend to have smaller brains](https://pubmed.ncbi.nlm.nih.gov/34989401/).  

"How about walking birds, like dodoes, who are not known for being intelligent?"
...
## Supercat conference
	...
	-
	  ...
	  --
## [Gwern](https://gwern.net/review/cat#are-cats-domesticated)  
...
"Hey -
## that explains the mystery of  octopus intelligence! Biologists have long puzzled about what octopus intelligence is for. What is it for? They aren't social like humans or ravens. But maybe they actually are social! Each octopus is already a 9-member society."
...
"Cat secretes [a certain chemical which causes allergies](https://en.wikipedia.org/wiki/Fel_d_1). And we have no idea whether it has any functions. Cats have wide variability in it, and some havig basically no such allergen is just fine in terms of health. More recently there had been [gene-edited cats](https://www.nature.com/articles/s41598-024-55464-0) so they don't produce that allergen, and it still seems to have no ill effects. So apparently it is useless for them as far as we can tell. So it is quite possible that we could get allergen-free cats for many breeds."

## Later in the night, Steve Hsu randomly showed up.
...
"On [St Kitts](https://en.wikipedia.org/wiki/Saint_Kitts), there are a lot of vervet monkeys, and they are considered pests. [Virscio](https://www.virscio.com/capabilities-resources/biological-resources/) is sending them to America for biomedical research. They work better than mice. They are not endangered, etc." [@researchPrimates21stCentury2003]
...
"Originally Patel's website was called The Lunar Society. It was bad in the Voltaire way. It was not Lunar, since he always recorded in the day, when the sun was out--"
...
"Do it. The brand is very important. Patel really should have changed his domain name to `dwarkesh.com` earlier. It probably costed him a lot of traffic."
...
"Yes, the waves have nice meditative sounds. But even when there is no sound, it still works. You can watch a video of waves with muted sound, and it is still mesmerizing."
...
Throughout the event, Gwern kept shilling about [genome synthesis](https://gwern.net/doc/genetics/genome-synthesis/index), and [dynamic evaluation](https://gwern.net/doc/ai/nn/dynamic-evaluation/index). It was perfectly on-brand. Alas, I am too uneducated in genetics to say more about the former.

"Genome synthesis should at some point cross over with the CRISPR editing, because all the offsite effects and such, so at some point the price should cross over. Perhaps editing 1000s of base pairs at once is just not worth it with CRISPR, and you should be just synthesizing a whole DNA segment and insert that into the genome all at once."
