...
format:
  html:
    ...
    resources:
        "figure/**"
description: "I discover the exact backstory to that picture of an airplane with red dots on top of it."
...
It was updated on 1943-11-01, still titled *Die Kriegsflugzeuge der Feindmächte*.
...
![Lockheed Hudson. Page 36a. The 4 armored oil tanks are marked out.](figure/Hudson_1942.png)
...
In [the 1943 update](https://www.lancasterbombers.net/kriegsflugzeuge-der-feindmachte/), the B-17 diagram has more details:
...
o3 looked up some information as to how thick the armor was in 1943 (I didn't check):

* Pilot windshield: 2.25 in bullet glass
* Top‑turret seat/back shield: 0.59 in armour plate
* Tail‑turret windscreen: 1.5 in bullet glass; side cheeks 1 in
* Misc. seat‑backs and splinter shields: ¼--½ in plate
