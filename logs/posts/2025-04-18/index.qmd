...
format:
  html:
    ...
    resources:
        "figure/**"
description: "To win (?) a twitter argument, we calculated the energetic cost of O'Neil habitat per person. Oddly, it is just affordable by modern standards. About 0.6 million dollars per person. Let it be known that the SF housing crisis is cheaper to solve by building O'Neil cylinders."
