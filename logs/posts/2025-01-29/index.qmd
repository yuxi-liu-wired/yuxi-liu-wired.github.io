...
format:
  html:
    ...
    resources:
        "figure/**"
description: "Thoughts on the recent so-called 'DeepSeek shock' of the stock market. The market is being even *less* efficient than usual, and much of the 'professional' commentators are idiots or bullshitters. I wrote this post to prevent my Gell-Mann amnesia."
...
[Nearcyan claimed](https://x.com/nearcyan/status/1884467386964951379) that the market was probably manipulated by insiders, who designed a crash in the AI sectors so that they can profit ("feed the sharks"). She didn't elaborate but I presume it means some of the following:
...
I don't know whether someone manipulated the market, because I am an outsider to the financial establishment, and I don't know how to psychoanalyze the market.
...
[^deepseek-app-date]: Surprisingly hard to figure out when exactly this happened. Apparently, 2025-01-10 [release](https://www.msn.com/en-us/technology/artificial-intelligence/what-is-deepseek-ai-and-why-is-it-suddenly-so-important/ar-AA1xX9Xv), 2025-01-26 hitting No. 1.
