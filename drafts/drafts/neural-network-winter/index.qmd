...
As we expect, Chomsky rejected statistical language learning right until the end.
...
Similarly, Gary Marcus has been consistently critical of neural network language models since 1992 [Overregularization in language acquisition]. His theory of intelligence is essentially Chomsky's: neural networks can be intelligent, but only if they implement symbolic manipulation rules. Furthermore, a lot of symbolic rules must be built in at birth, as the "poverty of stimulus".[^gary-marcus-poverty-of-stimulus] This theory is described in detail in *The Algebraic Mind* [@TODO]. In view of this history, we would be unsurprised by his recent criticisms of deep learning [Deep learning: A critical appraisal] and [large language models](https://www.technologyreview.com/2020/08/22/1007539/gpt3-openai-language-generator-artificial-intelligence-ai-opinion/), [repeatedly](https://www.theatlantic.com/technology/archive/2023/03/ai-chatbots-large-language-model-misinformation/673376/).

[^gary-marcus-poverty-of-stimulus]:
    The "poverty of stimulus" is a critical argument used by Chomsky to argue that humans must have a lot of stuff at birth, because there is too little after-birth stimulus for humans to learn languages. A very similar argument is used by Gary Marcus, as seen in [Deep learning: A critical appraisal]
